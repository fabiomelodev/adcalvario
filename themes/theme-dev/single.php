	...
	<main id="main" class="site-main">
		...
		<?php while (have_posts()):
			...
			<section class="relative bg-black pt-32 lg:pt-60 pb-10 lg:pb-32 lg:pb-0">
				...
				<div class="w-full h-full top-0 left-0 absolute z-10"
					style="background-image: linear-gradient(to right, #000 50%, transparent)"></div>

				<div class="w-1/2 h-full top-0 right-0 absolute"
				...
				<div class="container relative flex flex-wrap z-10">
					...
					<div class="w-full lg:w-8/12 lg:pl-24">
						...
						<h1 class="text-[64px] md:text-[80px] lg:text-[100px] font-bold text-white mb-12"
			...
			<section class="relative bg-black -mt-1 lg:mt-0 pt-4 lg:pt-32">
				...
				<div class="w-1/2 h-52 bottom-0 right-0 absolute"
						...
						<div class="flex flex-wrap">
							...
							if ($other_posts->have_posts()):
								while ($other_posts->have_posts()):
									...
									?>
									<a class="w-full block text-lg font-semibold text-white mb-2 last:mb-0"
										...
										<div>
											<?php foreach (get_the_tags($post) as $tag): ?>
												<span
													class="shadow-lg rounded-lg text-[10px] font-medium text-white bg-purple-900 mr-2 last:mr-0 py-1 px-2">
													<?php echo $tag->name; ?>
												</span>
											<?php endforeach; ?>
										</div>
