                    ...
                    while (have_rows('diretoria')):
                        ...
                        <div class="w-1/2 px-16">
                            ...
                            <div>
                                ...
                                <ul class="gap-4 flex justify-center mt-2">
                                    <?php if (get_sub_field('facebook')): ?>
                                        <li>
                                            <a class="w-7 h-7" href="<?php echo get_sub_field('facebook') ?>" target="_blank"
                                                rel="noreferrer noopener">
                                                <svg class="w-7 h-7 fill-[#9D0A26] hover:fill-[#3B5998]"
                                    ...
                                    <?php if (get_sub_field('instagram')): ?>
                                        <li>
                                            <a class="w-7 h-7" href="<?php echo get_sub_field('instagram') ?>" target="_blank"
                                                rel="noreferrer noopener">
                                                <svg class="w-7 h-7 fill-[#9D0A26] hover:fill-[#C32AA3]"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                                    <path
