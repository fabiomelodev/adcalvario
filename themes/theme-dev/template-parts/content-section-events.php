                ...
                <div class="swiper-wrapper">
                    ...
                    if ($events->have_posts()):
                        while ($events->have_posts()):
                            $events->the_post();
                            array_push($posts_month_current, get_the_ID());
                            ?>
                                ...
                                <a class="mb-8" href="<?php the_permalink() ?>">
                                    <div class="overflow-hidden rounded-[10px] shadow-xl bg-white">
                                        ...
                                        <div class="flex pb-4 pl-8">
                                            <div
                                                class="w-[70px] h-[70px] rounded-xl border border-[#BA6239] flex justify-center items-center bg-white -mt-8">
                                            ...
                                            <div class="pl-4">
                                                ...
                                                <p
                                                    class="rounded-[4px] inline-block text-[7px] italic text-white bg-gradient-to-r from-[#9D0A26] to-[#BA6239] py-1 px-8">
                                                    <!-- Em breve -->
                                    ...
                                    <div
                                        class="transition duration-300 hover:scale-90 rounded-[10px] bg-gradient-to-r from-[#9D0A26] to-[#BA6239] mt-4 p-2">
                    ...
                    <?php else: ?>
                        <div class="swipe-slide">
                            <div class="w-full rounded-lg shadow-xl flex flex-col items-center gap-y-6 bg-red-200 p-4">
                                <svg class="w-10 fill-red-400" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="swiper js-swiper-events">
                ...
                <div class="swiper-wrapper">
                    ...
                    $args = array(
                        'posts_per_page' => -1,
                        'post_type' => 'evento',
                        'post__not_in' => $posts_month_current,
                        'meta_query' => array(
                            array(
                                'key' => 'data_do_evento',
                                'value' => $date_current,
