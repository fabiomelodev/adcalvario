                            ...
                            while ($events->have_posts()):
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="flex gap-x-4">
                                        <a class="font-normal uppercase text-center text-[#BA6239] hover:text-white bg-white hover:bg-[#BA6239] py-2 px-4"
                                            href="<?php echo get_home_url(null, 'fotos/?ev=' . $post->post_name) ?>">
                                            Fotos
                                        </a>

                                        <a class="border-b-2 border-white font-normal uppercase text-white hover:text-[#BA6239] hover:bg-white py-2 px-4"
