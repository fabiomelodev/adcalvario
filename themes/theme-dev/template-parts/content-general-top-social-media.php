<section class="w-full h-[594px] relative hidden bg-cover bg-no-repeat"
...
<section class="w-full h-20 relative hidden xl:flex items-center bg-[#9D0A26]">
            ...
            while (have_rows('redes_sociais', 'option')):
                ...
                if ($status):
                    ...
                    <a class="group flex justify-center items-center gap-4 py-4" href="<?php echo get_sub_field('link') ?>"
                        target="_blank" rel="noreferrer nopenener">
                        <?php if (get_sub_field('icone') == 'Facebook'): ?>
                            <?php echo get_template_part('template-parts/icons/content', 'facebook', get_icon_setting('w-9 h-9 fill-white group-hover:fill-[#bc7051]')); ?>
                        <?php endif; ?>

                        <?php if (get_sub_field('icone') == 'Instagram'): ?>
                            <?php echo get_template_part('template-parts/icons/content', 'instagram', get_icon_setting('w-9 h-9 fill-white group-hover:fill-[#bc7051]')); ?>
                        <?php endif; ?>

                        <?php if (get_sub_field('icone') == 'Whatsapp'): ?>
                            <?php echo get_template_part('template-parts/icons/content', 'whatsapp', get_icon_setting('w-9 h-9 fill-white group-hover:fill-[#bc7051]')); ?>
                        <?php endif; ?>

                        <?php if (get_sub_field('icone') == 'Youtube'): ?>
                            <?php echo get_template_part('template-parts/icons/content', 'youtube', get_icon_setting('w-9 h-9 fill-white group-hover:fill-[#bc7051]')); ?>
                        <?php endif; ?>

                        <span class="text-sm font-bold text-white group-hover:text-[#bc7051]">
                            <?php echo get_sub_field('texto') ?>
                        </span>
                    </a>
                    <?php
